...
| Fight knowledge (M3b) | [skills](knowledge/shaman-skills.jsonl), [chains](knowledge/fight-chains.jsonl), [mechanics](knowledge/combat-mechanics.md), [owner rules](knowledge/owner-rules.md) | Read by the fight graph at run time. Skills: 44 Shaman rows for levels 1-20 from a web search by Composer 2.5 (25 Sept), spot-checked by the author against the source; live tooltips on client 1.60.1.69977 differ for three and win. Chains: the owner's and the guides' presets, one candidate. Mechanics: marked live or source claim. |
