...
- Quest types: hunt, interact, collect, escort, puzzles and quest-specific references.
  Hunt is connected. Quest hand-ins within one walk are connected through [the quest graph](skyborne-quest.graph.json) (M4f); taking quests from a "!" giver, kill/collect/use-at quests and zone travel are not.
