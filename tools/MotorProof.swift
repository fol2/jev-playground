...
let minFightChecks = 215  // the current count: removing a check must lower this on purpose
let minNavChecks = 279  // the current count: removing a check must lower this on purpose
