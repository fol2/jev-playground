...
let minPerceptionChecks = 28  // M5: the current count: removing a check must lower this on purpose
...
func motorProof(update: Bool) throws -> String {
    ...
    try refuses(perceive, [[], ["--bogus"], ["--propose", "x"], ["--sheet"], ["--sheet", "0"], ["--sheet", "x"], ["--sheet", "601"], ["--sheet-held"], ["--sheet-held", "0"], ["--sheet-held", "601"], ["--sheet-frames"], ["--sheet-frames", "0"], ["--baseline", "x"], ["--train", "x"], ["--prelabel", "x"], ["--audit"], ["--audit", "a", "b"]])
