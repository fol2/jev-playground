...
let minNavChecks = 274  // the current count: removing a check must lower this on purpose
...
let minPerceptionFrames = 2449  // the current count: dropping frames from the set must lower this on purpose
