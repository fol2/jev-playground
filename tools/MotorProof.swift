...
let minNavChecks = 270  // the current count: removing a check must lower this on purpose
...
let minPerceptionFrames = 2445  // the current count: dropping frames from the set must lower this on purpose
